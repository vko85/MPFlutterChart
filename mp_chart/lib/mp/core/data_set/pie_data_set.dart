...
class PieDataSet extends DataSet<PieEntry> implements IPieDataSet {
  ...
  ValuePosition _xValuePosition = ValuePosition.insideSlice;
  ValuePosition _yValuePosition = ValuePosition.insideSlice;
  bool _usingSliceColorAsValueLineColor = false;
  Color _valueLineColor = const Color(0xff000000);
  ...
  void setXValuePosition(ValuePosition xValuePosition) {
    _xValuePosition = xValuePosition;
  }
  ...
  void setYValuePosition(ValuePosition yValuePosition) {
    _yValuePosition = yValuePosition;
  }
  ...
  void setUsingSliceColorAsValueLineColor(
    ...
    _usingSliceColorAsValueLineColor = usingSliceColorAsValueLineColor;
  }
  ...
  void setValueLinePart1OffsetPercentage(
    ...
    _valueLinePart1OffsetPercentage = valueLinePart1OffsetPercentage;
  }
  ...
  void setValueLinePart1Length(double valueLinePart1Length) {
    _valueLinePart1Length = valueLinePart1Length;
  }
  ...
  void setValueLinePart2Length(double valueLinePart2Length) {
    _valueLinePart2Length = valueLinePart2Length;
  }
  ...
  void setValueLineVariableLength(bool valueLineVariableLength) {
    _valueLineVariableLength = valueLineVariableLength;
  }
}
