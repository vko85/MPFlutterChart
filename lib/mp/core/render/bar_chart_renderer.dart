...
import 'package:mp_chart_x/mp/core/buffer/bar_buffer.dart';
...
import 'package:mp_chart_x/mp/core/render/bar_line_scatter_candle_bubble_renderer.dart';
...
class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
  ...
  void drawHighlighted(Canvas c, List<Highlight>? indices) {
    ...
    for (Highlight high in indices!) {
      ...
      BarEntry? e = set.getEntryForXValue2(high.x ?? 0, high.y ?? 0);
